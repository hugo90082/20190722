...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="okOrCancel" type="submit" name="okOrCancel" class="btn btn-success">OK</button>
    <button id="okOrCancel" type="submit" name="okOrCancel" class="btn btn-danger">Cancel</button>
  </div>
</div>
